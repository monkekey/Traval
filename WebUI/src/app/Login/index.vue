                ...
                new Model()
                    ...
                    .then((response) => {
                      if(response.data.success){
                          ...
                          // localStorage.setItem('travel_butler_token', response.data.data.token)
                          // localStorage.setItem('travel_butler_userinfo', JSON.stringify(response.data.data.userinfo))
