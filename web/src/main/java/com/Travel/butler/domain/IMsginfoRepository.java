...
//public List<Guest> findUnReadMsgGuest(@Param("checkinInn") String checkinInn, @Param("fromGuest") String fromGuest, @Param("chatTime") Date chatTime);
    ...
    @Query(value = "select new com.Travel.butler.vo.Guest(v.openid, v.guestName) from Msginfo v where v.checkinInn = :checkinInn  and v.fromGuest = '1' and v.chatTime>=:chatTime group by openid, guestName")
