...
//		System.out.println(encoder.encode("lf13579"));
		...
		String appid = "wx2beff41aac1e0bbb";
		String secret = "1b8c93471f8669ddfeffaacfdcf33812";
		String encryptStr = encrypt(secret, StringUtils.sortByChart(appid.concat("Travel")).substring(0, 8));
